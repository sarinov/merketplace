...
<div class=" d-flex">
    ...
    <p class="count" id="counte{{$products->id}}" style="margin-right: 20px;" >counte: <b>{{$products->counte}}</b></p> 
 
    <p class="like" id="like{{$products->id}}" style="margin-right: 20px;">Like: {{$products->like}}</p>
    <p class="dislike" id="dislike{{$products->id}}" style="margin-right: 20px;">Dislike: {{$products->dislike}}</p> 
